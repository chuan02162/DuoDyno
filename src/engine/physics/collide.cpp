...
int Collide(Contact* contacts, const std::shared_ptr<Body>& bodyA, const std::shared_ptr<Body>& bodyB)
{
	// Setup
	Vec2 hA = 0.5f * bodyA->collider->width;
	Vec2 hB = 0.5f * bodyB->collider->width;
